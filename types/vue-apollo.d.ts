...
type PickedObservableQuery = Pick<
  ObservableQuery,
  | "fetchMore"
  | "subscribeToMore"
  | "refetch"
...
interface ApolloClientMethods {
  query<R = any, TVariables = OperationVariables>(
    options: QueryOptions<TVariables> & ClientOptions,
  ): Promise<ApolloQueryResult<R>>;
  watchQuery<R = any, TVariables = OperationVariables>(
    options: WatchQueryOptions<TVariables> & ClientOptions,
  ): ObservableQuery<R, TVariables>;
  mutate<R = any, TVariables = OperationVariables>(
    options: MutationOptions<R, TVariables> & ClientOptions,
  ): Promise<FetchResult<R>>;
  subscribe<R = any, TVariables = OperationVariables>(
    options: SubscriptionOptions<TVariables> & ClientOptions,
...
export interface DollarApollo<V> extends ApolloClientMethods {
  ...
  addSmartQuery<R = any>(
    key: string,
    options: VueApolloQueryDefinition<R>,
  ): SmartQuery<V>;
  addSmartSubscription<R = any>(
    key: string,
    options: VueApolloSubscriptionDefinition,
  ): SmartSubscription<V>;
}
